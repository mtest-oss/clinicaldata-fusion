...
class CNN(nn.Module):
    def __init__(self, args):
        ...
        if args.inputs==7 or args.inputs==4:
            #self.vocab_embedding = nn.Embedding (args.unstructure_size+10, args.embed_size )
            self.vocab_embedding = nn.Embedding (1000, args.embed_size )
    ...
    def forward(self, x, t, dd, content=None):
        ...
        if content is not None:
            ...
            content = self.vocab_layer(content.transpose(1,2)) #Debig: Manasa from comment
