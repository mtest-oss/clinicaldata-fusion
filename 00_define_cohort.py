...
if __name__ == '__main__':
    ...
    #begin_new
    #df_adm['age'] = df_adm.apply(lambda e: (e['admittime'] - e['dob']).days/365, axis=1)
    df_adm['age'] = ((df_adm['admittime'].values - df_adm['dob'].values).astype(np.int)/365.242).astype(np.int)
    #end_new
